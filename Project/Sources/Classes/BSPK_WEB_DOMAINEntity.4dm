...
Function get defaultLang->$vt_DefaultLang : Text
	var $Langs : cs:C1710.BSPK_WEB_DOMAIN_LANGSelection
	$Langs:=This:C1470.WebDomainLang.query("isDefault = :1"; True:C214)
	return ($Langs.length>0) ? $Langs[0].lang : ""
	
Function getLangs->$vc_Langs : Collection
	var $WebDomainLang : cs:C1710.BSPK_WEB_DOMAIN_LANGEntity
	
	$vc_Langs:=[]
	For each ($WebDomainLang; This:C1470.WebDomainLang)
		$vc_Langs.push($WebDomainLang.lang)
	End for each 